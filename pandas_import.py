...
for frame in framelist:
    newframe = newframe.join(frame, on = 'time', how='left', lsuffix='_left', rsuffix='_right')

newframe = newframe.fillna(0)
newframe['time5'] = pd.Series(newframe.index.round('5min'), index = newframe.index)
newframe['time15'] = pd.Series(newframe.index.round('15min'), index = newframe.index)
# print(newframe)
...
want_5['bolus'] = pd.Series(grouped_sum_5['bolus'], index = grouped_sum_5.index)
want_5['meal'] = pd.Series(grouped_sum_5['meal'], index = grouped_sum_5.index)
want_5['smbg'] = pd.Series(grouped_avg_5['smbg'], index = grouped_avg_5.index)
want_5['hr'] = pd.Series(grouped_avg_5['hr'], index = grouped_avg_5.index)
want_5['cgm'] = pd.Series(grouped_avg_5['cgm'], index = grouped_avg_5.index)
want_5['basal'] = pd.Series(grouped_avg_5['basal'], index = grouped_avg_5.index)
...
want_15['bolus'] = pd.Series(grouped_sum_15['bolus'], index = grouped_sum_15.index)
want_15['meal'] = pd.Series(grouped_sum_15['meal'], index = grouped_sum_15.index)
want_15['smbg'] = pd.Series(grouped_avg_15['smbg'], index = grouped_avg_15.index)
want_15['hr'] = pd.Series(grouped_avg_15['hr'], index = grouped_avg_15.index)
want_15['cgm'] = pd.Series(grouped_avg_15['cgm'], index = grouped_avg_15.index)
want_15['basal'] = pd.Series(grouped_avg_15['basal'], index = grouped_avg_15.index)
